...
export default function NetworkPage() {
  ...
  const TIERS = [
    {
      name: t("network.tier1_name"),
      active: false,
      condition: null,
      perks: t("network.tier1_perks", { returnObjects: true }) as string[],
    },
    {
      name: t("network.tier2_name"),
      active: true,
      condition: t("network.tier2_cond"),
      perks: t("network.tier2_perks", { returnObjects: true }) as string[],
    },
    {
      name: t("network.tier3_name"),
      active: false,
      condition: t("network.tier3_cond"),
      perks: t("network.tier3_perks", { returnObjects: true }) as string[],
    },
  ];
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8" style={{ background: "#111111" }}>
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-white/50 text-lg max-w-xl mx-auto">{t("network.tiers_subtitle")}</p>
          </motion.div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            <div className="text-center mb-12">
              ...
              <p className="text-white/50">{t("network.form_subtitle")}</p>
            </div>
            ...
            {success ? (
              ...
              >
                ...
                <p className="text-white/60 leading-relaxed">{t("network.success_body")}</p>
              </div>
            ) : (
              <form
              ...
              >
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="1-3" style={{ background: "#1a1a1a" }}>
                      {t("network.property_1_3")}
                    </option>
                    <option value="4-10" style={{ background: "#1a1a1a" }}>
                      {t("network.property_4_10")}
                    </option>
                    <option value="10+" style={{ background: "#1a1a1a" }}>
                      {t("network.property_10p")}
                    </option>
                  </select>
                </div>
