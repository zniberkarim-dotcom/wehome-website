...
import {
  ...
  Building2, Layers, CheckCircle2, ChevronLeft, ChevronRight, X, Maximize2
} from "lucide-react";
...
export default function BienPage() {
  ...
  const whatsappVisitMessage = encodeURIComponent(
    `Bonjour WeHome,\n\nJ'aimerais planifier une visite pour le bien "${property.title}" (Réf: ${property.id}) situé à ${property.location}.\n\nQuelles sont vos disponibilités ?\n\nMerci !`
  );
  const whatsappVisitUrl = `https://wa.me/212653535156?text=${whatsappVisitMessage}`;
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <a
                        ...
                        className="w-full py-3.5 rounded-xl bg-[#25D366] text-white font-bold flex items-center justify-center gap-2 hover:bg-[#1da851] transition-colors duration-300"
                      >
