    ...
    <DashboardLayout title="Mon Profil">
      <div className="max-w-2xl space-y-8">
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          >
            <h2 className="text-xs font-semibold text-foreground/70 mb-4 uppercase tracking-wider">
              Photo de profil
            </h2>
          ...
          >
            <h2 className="text-xs font-semibold text-foreground/70 mb-2 uppercase tracking-wider">
