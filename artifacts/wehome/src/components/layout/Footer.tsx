        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a
                href="https://www.instagram.com/wehomeagency?igsh=ZDF5MTZ6ZzM3YXly"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-white/80 hover:bg-primary hover:text-white transition-colors"
              >
                <Instagram size={20} />
              </a>
              <a
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/60">
              <li>
                <Link href="/acheter" className="hover:text-primary transition-colors">
                  {t("footer.buy_property")}
                </Link>
              </li>
              <li>
                <Link href="/louer" className="hover:text-primary transition-colors">
                  {t("footer.rent_property")}
                </Link>
              </li>
              <li>
                <Link href="/publier" className="hover:text-primary transition-colors">
                  {t("footer.sell_property")}
                </Link>
              </li>
              <li>
                <Link href="/services-pro" className="hover:text-primary transition-colors">
                  {t("footer.services_pro", "Services Pro pour particuliers")}
                </Link>
              </li>
              <li>
                <Link href="/weoffice" className="hover:text-primary transition-colors">
                  {t("footer.weoffice", "WeOffice — Bureaux & entreprises")}
                </Link>
              </li>
              <li>
                <Link href="/estimer" className="hover:text-primary transition-colors">
                  {t("footer.estimate_property")}
                </Link>
              </li>
              <li>
                <Link href="/financement" className="hover:text-primary transition-colors">
                  {t("footer.financing_calc")}
                </Link>
              </li>
              <li>
